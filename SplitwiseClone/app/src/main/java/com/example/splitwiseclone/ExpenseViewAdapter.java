...
public class ExpenseViewAdapter extends RecyclerView.Adapter<ExpenseViewAdapter.ViewHolder1> {
    ...
    public ExpenseViewAdapter(Context mContext, ArrayList<String> title, ArrayList<String> amount, ArrayList<String> paidBy, ArrayList<String> date ) {
        Titleexp = title;
        Amountexp = amount;
        PaidByexp = paidBy;
        Dateexp = date;
    ...
    @Override
    public void onBindViewHolder(@NonNull ViewHolder1 holder, @SuppressLint("RecyclerView") final int position) {
